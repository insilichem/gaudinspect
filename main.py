...
class GAUDInspectMain(QtGui.QMainWindow):

    def __init__(self):
        super(GAUDInspectMain, self).__init__()
    ...
    def initUI(self):
        ...
        self.grid = QtGui.QGridLayout(self.canvas)
        ...
        self.genes_list = QtGui.QListWidget(self.canvas)
        ...
        self.objectives_list = QtGui.QListWidget(self.canvas)
        ...
        self.general_grid.addWidget(self.general_generations_label, 0, 0)
        self.general_generations_field = QtGui.QLineEdit(self.general_group)
        ...
        self.general_grid.addWidget(self.general_generations_field, 0, 1)
        # Population
        self.general_population_label = QtGui.QLabel('Population')
        self.general_population_label.setAlignment(
            QtCore.Qt.AlignRight | QtCore.Qt.AlignVCenter)
        self.general_grid.addWidget(self.general_population_label, 1, 0)
        self.general_population_field = QtGui.QLineEdit(self.general_group)
        ...
        self.general_grid.addWidget(self.general_population_field, 1, 1)
        # Name of project
        ...
        self.general_project_field = QtGui.QLineEdit(self.general_group)
        ...
        self.general_outputpath_label.setAlignment(
            QtCore.Qt.AlignRight | QtCore.Qt.AlignVCenter)
        self.general_grid.addWidget(self.general_outputpath_label, 1, 2)
        self.general_outputpath_field = QtGui.QLineEdit(self.general_group)
        self.general_outputpath_field.setMaxLength(15)
        self.general_grid.addWidget(self.general_outputpath_field, 1, 3)
        self.general_outputpath_browse = QtGui.QPushButton('...')
        self.general_grid.addWidget(self.general_outputpath_browse, 1, 4)
...
def main():
    ...
    gaudinspectmain = GAUDInspectMain()
    sys.exit(app.exec_())
